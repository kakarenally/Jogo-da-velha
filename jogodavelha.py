...
def iniciar_jogo():
    ...
    def controlar(i):
        ...
        if i==str(3):
            # verificando se aquela posicao esta vazia ou nao
            if b_2['text']=='':
                # varificando quem esta jogando e assim definir a cor do simbolo
                if jogando =='X':
                    cor=co7
                if jogando =='O':
                    cor=co8
        ...
        if i==str(5):
            # verificando se aquela posicao esta vazia ou nao
            if b_4['text']=='':
                # varificando quem esta jogar e assim definir a cor do simbolo
                if jogando =='X':
                    cor=co7
                if jogando =='O':
                    cor=co8
        ...
        if i==str(6):
            # verificando se aquela posicao esta vazia ou nao
            if b_5['text']=='':
                # verificando quem esta jogando e assim definir a cor do smbolo
                if jogando =='X':
                    cor=co7
                if jogando =='O':
                    cor=co8
        ...
        if i==str(9):
            # verificando se aquela posicao esta vazia ou nao
            if b_8['text']=='':
                # varificando quem esta jogando e assim definir a cor do smbolo
                if jogando =='X':
                    cor=co7
                if jogando =='O':
                    cor=co8
        ...
        # verificar se houve algum vencedor de acordo 
